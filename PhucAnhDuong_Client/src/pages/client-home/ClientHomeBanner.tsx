    ...
    <Grid>
      <Grid.Col md={7} lg={8}>
        ...
        <ClientCarousel>
          <Box>
            <img
              src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTq952jEPGZkd8thLYk28zSrvFU0bHFDaR8Kg&s'
          ...
          <Box>
            <img
              src='https://cdn.mediamart.vn/images/news/huong-dan-cach-giu-man-hinh-ipad-luon-sang_6d3d8a8d.png'
              alt='Description of image 1'
              style={{ height: 300, minHeight: 315, width: '100%' }}
            />
          </Box>
          <Box>
            <img
              src='https://images.pexels.com/photos/577769/pexels-photo-577769.jpeg?cs=srgb&dl=pexels-parag-deshmukh-180046-577769.jpg&fm=jpg'
              alt='Description of image 1'
          ...
          <Box>
            <img
              src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKFbgSMEec5N25I-eUFLTNrZ__GJOlx7gCXw&s'
              alt='Description of image 1'
              style={{ height: 300, minHeight: 315, width: '100%' }}
            />
          </Box>
